...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        user: process.env.EMAIL_USER || 'fauzelfarhan956@gmail.com',
        pass: process.env.EMAIL_PASSWORD || 'cwkctnatzjswdwmf'
    }
});
...
app.listen(PORT, () => {
    ...
    If your Google account has 2-Step Verification enabled, create an App Password and use it as EMAIL_PASSWORD.
    Do NOT commit your .env file or credentials to version control.
    
    All quote requests will be sent to: ${ADMIN_EMAIL}
    `);
});